...
export const InventarioDescontinuado = () => {
  ...
  return (
    <>
      <h1 className="mb-3 fw-bold">Inventario descontinuado</h1>

      <h6>En esta sección encontrarás las categorias de inventario que se encuentra descontinuado en el residencial.</h6>
                                                                    ...
                                                                    <div class="card text-center order-visitor-card  p-4">
                                                                        <a href="inventario-table.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <AiFillIdcard color="red" size={"1.5em"}/> 0
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-areas.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-b-15">
                                                                                <BiCoffee color="green" size={"1.5em"}/> 0
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-temporada.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-t-15 m-b-15">
                                                                                <AiOutlineStar color="red" size={"1.5em"}/> 0
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-transporte.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-t-15 m-b-15">
                                                                                <FiTruck color="green" size={"1.5em"}/> 0 
                                                                                </h4>
                                                                                <p class="m-b-0"></p>
                                                                            </div>
                                                                        </a>
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-vigilancia.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-t-15 m-b-15">
                                                                                <BsFillCameraVideoFill color="red" size={"1.5em"}/> 0 
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-jardineria.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-t-15 m-b-15">
                                                                                <FaLeaf color="green" size={"1.5em"}/> 0 
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-admin.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-t-15 m-b-15">
                                                                                <AiFillFile color="red" size={"1.5em"}/> 0 
                                                                    ...
                                                                    <div class="card text-center order-visitor-card p-4">
                                                                        <a href="inventario-table-otros.php">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <h4 class="m-t-15 m-b-15">
                                                                                <AiFillTag color="red" size={"1.5em"}/> 0 
