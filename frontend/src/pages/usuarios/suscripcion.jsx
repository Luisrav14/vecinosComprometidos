                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="card" style={{ width: "80%" }}>
                          ...
                          <div className="card-body border rounded">
                            ...
                            <h2 className="card-text text-center mb-3" style={{ fontSize: "1.2rem" }}>
                              <strong>$ 566.00 MXP</strong>{" "}
                            </h2>
                            <div className="text-center">
                              <a href="/dashboard/tarjeta" className="btn btn-primary">
                                Seleccionar
                              </a>
                            </div>
                          </div>
